		  ...
		  <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method='post' action='aksi_beras.php?act=input'>
                    ...
                    <div class="form-group">
                      <label for="alamat">Jenis Produk</label>
                      <input type="text" class="form-control" name="JENISPRODUK" placeholder="masukkan jenis">
					  
                    </div>
                    <div class="form-group">
                      <label for="alamat">Harga</label>
                      <input type="number" class="form-control" name="HARGAPRODUK" placeholder="harga">
